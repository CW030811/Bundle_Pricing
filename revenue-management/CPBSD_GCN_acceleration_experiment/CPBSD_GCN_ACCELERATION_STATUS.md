...
- **结果文件**：`experiments/cpbsd_baselines/diagnostics/bcs_tightness_N5K10_seed901.txt`
...
路径：`revenue-management/code_submission_project/code_submission/experiments/cpbsd_baselines/`
