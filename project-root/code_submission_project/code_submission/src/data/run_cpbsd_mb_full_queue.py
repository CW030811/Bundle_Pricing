...
def main():
    parser = argparse.ArgumentParser(description="Run full CPBSD MB labeling queue across train/eval/test splits.")
    ...
    queue_script = SCRIPT_DIR / "run_cpbsd_mb_chunk_queue.py"
